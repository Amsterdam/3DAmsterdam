...
public class PijlenPrefab : MonoBehaviour
{
    ...
    private float scalingXZ, scaleFactor = 2f, scalingDif = 2f;
    ...
    private void UpdateScale()
    {
        if (pijlenPrefab != null)
        {
            ...
            pijlenPrefab.transform.localScale = new Vector3(Mathf.Sign(largestSize.z * scaleFactor + largestSize.x * scaleFactor), 3, Mathf.Sign(largestSize.z * scaleFactor + largestSize.x * scaleFactor));
