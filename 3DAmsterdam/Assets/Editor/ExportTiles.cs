...
public class ExportTiles 
{
    ...
    private static void ExporteerOBJ()
    {
        ...
        for (int i = 0; i < Parent.transform.childCount; i++)
        {
                ...
                string kindnaam =Parent.transform.GetChild(i).name;
    ...
    static void SaveTile(GameObject TileToSave)
    {
        ...
        foreach (Vector3 item in newVertices)
        {
            ...
            Vector3 UnityCoordinaat = item;
                UnityCoordinaat.x = UnityCoordinaat.x * TileToSave.transform.localScale.x;
            UnityCoordinaat.z = UnityCoordinaat.z * TileToSave.transform.localScale.z;
