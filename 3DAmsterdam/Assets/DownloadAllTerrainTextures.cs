...
public class DownloadAllTerrainTextures : MonoBehaviour
{
	...
	private IEnumerator DownloadAll()
	{
        ...
        foreach(var zDir in zDirs)
        {
            ...
            foreach (var xDir in xDirs)
            {
                ...
                {
                    Debug.Log("Started downloading a texture");
                    StartCoroutine(SeperateFileProgress(xDir,yFile,zDir));
                }
                ...
                Debug.Log("Textures downloaded: " + filesDownloaded);
                yield return new WaitForEndOfFrame();
            }
        }   
	...
	private IEnumerator SeperateFileProgress(string xDir, string yFile, string zDir)
	{
